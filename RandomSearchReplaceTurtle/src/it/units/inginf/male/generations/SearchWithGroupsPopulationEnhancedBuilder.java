 ...
 */
public class SearchWithGroupsPopulationEnhancedBuilder implements InitialPopulationBuilder {
     ...
     * and digits with "\\d"
     */
    public SearchWithGroupsPopulationEnhancedBuilder() {
     ...
     */
    public SearchWithGroupsPopulationEnhancedBuilder(boolean useDottification, boolean useWordClasses) {
    ...
    public void setup(SubConfiguration configuration) {
        ...
        try {
            this.population.add(Utils.deserializeTree(RegexReader.readRegex((String) configuration.getProperties().get("regex_tree_file"), configuration.getConflictGroup().getGroupID())));
        }catch(Exception e){
            e.printStackTrace();
