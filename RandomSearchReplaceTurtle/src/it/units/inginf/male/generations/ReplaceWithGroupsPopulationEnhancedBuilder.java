 ...
 */
public class ReplaceWithGroupsPopulationEnhancedBuilder implements InitialPopulationBuilder {
     ...
     * and digits with "\\d"
     */
    public ReplaceWithGroupsPopulationEnhancedBuilder() {
    }
    ...
    public void setup(SubConfiguration configuration) {
        ...
        try {
            List<String> serializedTrees = RegexReader.readReplacement((String) configuration.getProperties().get("regex_tree_file"), configuration.getConflictGroup().getGroupID());
