...
public class Configurator {
    ...
    public static Configuration configure(String fileName, String dataSetFileName, ConflictGroup conflictGroup, Properties properties) throws IOException {
        FileInputStream fis = new FileInputStream(new File(fileName));
        InputStreamReader isr = new InputStreamReader(fis);
        StringBuilder sb;
        try (BufferedReader bufferedReader = new BufferedReader(isr)) {
        ...
        for (SubConfiguration subConfiguration : configuration.getSubConfigurations()) {
            subConfiguration.setConflictGroup(conflictGroup);
            subConfiguration.setProperties(properties);
        }
